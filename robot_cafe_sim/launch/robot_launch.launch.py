...
def generate_launch_description():
    ...
    pkg = FindPackageShare("robot_cafe_sim").find("robot_cafe_sim")
    ...
    args = [
        ...
        DeclareLaunchArgument("robot_name", default_value="CafeRobot"),
    ...
    robot_state_publisher = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(pkg, "launch", "robot_state_publisher.py")),
        launch_arguments={
