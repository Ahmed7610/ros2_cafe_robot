...
def generate_launch_description():
    ...
    package_name_gazebo = "warehouse_system"
    package_name_localization = "warehouse_system"
    ...
    rviz_config_file_path = "rviz/rviz_parameters.rviz"

    # Set the path to different packages
    pkg_share_gazebo = FindPackageShare(package=package_name_gazebo).find(
        package_name_gazebo
    )
    pkg_share_localization = FindPackageShare(package=package_name_localization).find(
        package_name_localization
    )
