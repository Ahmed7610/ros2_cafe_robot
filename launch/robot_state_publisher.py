...
ARGUMENTS = [
    DeclareLaunchArgument(
        "robot_name", default_value="warehouse_car", description="Name of the robot"
    ),
    DeclareLaunchArgument(
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = "ros2_cafe_robot"
    urdf_filename = "robot.xacro"
    rviz_config_filename = "rviz_parameters.rviz"
